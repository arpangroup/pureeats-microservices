...
public class BaseException extends RuntimeException {
    ...
    public  @NonNull ErrorMessage getErrorMessage(){
    ...
    public enum ExceptionReason {
        ...
        private final BaseException.Series series;
        private final String reasonPhrase;

        ExceptionReason(String value, BaseException.Series series, String reasonPhrase) {
            this.value = value;
            this.series = series;
         ...
         */
        public BaseException.Series series() {
            return this.series;
        }
    ...
    public enum Series {
         ...
         */
        @Nullable
        public static BaseException.Series resolve(int statusCode) {
            int seriesCode = statusCode / 100;
            for (BaseException.Series series : values()) {
